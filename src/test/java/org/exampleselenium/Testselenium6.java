...
class Testselenium6 {
    ...
    public void verify_total_amount() throws InterruptedException {
        ...
        Thread.sleep(500);
        driver.findElement(By.xpath("//input[@id='first-name']")).sendKeys("KUNTI");
        driver.findElement(By.xpath("//input[@id='last-name']")).sendKeys("Pandit");
        driver.findElement(By.xpath("//input[@id='postal-code']")).sendKeys("22035");
